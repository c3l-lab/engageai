...
for user_id in triggered_users_id:
    ...
    send_message_to_user(MOODLE_URL, TOKEN, user_id, "📢 Hello! This is a reminder based on your submission duedate Reminder before 14 days before the actual duedate ")
